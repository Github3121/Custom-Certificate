                ...
                <div className="p-8 space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            ...
                            <input id="name" value={studentName} onChange={(e) => setStudentName(e.target.value)} type="text" placeholder="Md. Rahat" required className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {studentName && (
                        ...
                        <div className="relative">
                            ...
                            <input id="father" value={fatherName} onChange={(e) => setFatherName(e.target.value)} type="text" placeholder="Md. Jabed Hossain" required className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {fatherName && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            ...
                            <input id="mother" value={motherName} onChange={(e) => setMotherName(e.target.value)} type="text" placeholder="Roja Begum" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {motherName && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            ...
                            <input id="gpa" value={GPA} onChange={(e) => setGPA(e.target.value)} type="text" placeholder="4.50" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {GPA && (
                        ...
                        <div className="relative">
                            ...
                            <input id="birth" value={birthYear} maxLength={4} onChange={(e) => setBirthYear(e.target.value)} type="text" placeholder="2000" required className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {birthYear && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            ...
                            <input id="year" value={year} maxLength={3} onChange={(e) => setYear(e.target.value)} type="number" placeholder="19" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {year && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            ...
                            <input id="reg" value={reg} maxLength={10} onChange={(e) => setReg(e.target.value)} type="text" placeholder="10 digits" required className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {reg && (
                        ...
                        {/* Roll No */}
                        <div className="relative">
                            <label className="block text-sm font-medium text-slate-700 mb-2">Roll No. <span className={`${roll.length === 7 ? 'text-green-700' : 'text-red-400'} ${roll.length === 0 && 'hidden'}`}>{roll.length}</span></label>
                            <input id="roll" value={roll} maxLength={6} onChange={(e) => setRoll(e.target.value)} type="text" placeholder="193596" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {roll && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {/* Serial No */}
                        <div className="relative">
                            <label className="block text-sm font-medium text-slate-700 mb-2">Serial No. <span className={`${serial.length === 7 ? 'text-green-700' : 'text-red-400'} ${serial.length === 0 && 'hidden'}`}>{serial.length}</span></label>
                            <input id="sl" value={serial} maxLength={7} onChange={(e) => setSerial(e.target.value)} type="text" placeholder="7 digits" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 pr-10" />
                            {serial && (
                        ...
                        <div className="relative">
                            ...
                            <input id="dbchc" value={dbchc} maxLength={8} onChange={(e) => setDBCHC(e.target.value)} type="text" placeholder="8 digits" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-slate-800 placeholder-slate-400 pr-10" />
                            {dbchc && (
